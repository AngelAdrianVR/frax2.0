...
class PetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Community/Pets/Index', [
            'pets' => $pets,
        ]);
    }
    ...
    public function adminIndex(Request $request)
    {
        ...
        $pets->getCollection()->transform(function ($pet) {
            $primaryUser = $pet->privateUnit ? $pet->privateUnit->users()->first() : null;
            $userName = $primaryUser ? $primaryUser->name : 'N/A';
        ...
        return Inertia::render('Community/Pets/AdminIndex', [
            'pets' => $pets,
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Community/Pets/Create', [
