...
<template>
    <div class="min-h-screen bg-gray-50 dark:bg-zinc-900 transition-colors duration-300 font-sans">
        ...
        >
            <!-- Navbar Superior -->
            <nav class="bg-white dark:bg-zinc-800/90 sticky top-0 z-20 h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-zinc-700 backdrop-blur-sm shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    <button 
                        ...
                        class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-zinc-700 transition-colors focus:outline-none"
                    >
                ...
                <div class="flex items-center gap-3 md:gap-6">
                    ...
                    <div class="relative" id="unit-selector" v-if="currentUnit">
                        <button 
                            ...
                            class="flex items-center gap-2 md:gap-3 pl-3 pr-2 py-1.5 rounded-full border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-700/50 hover:bg-white dark:hover:bg-zinc-700 transition-all shadow-sm group"
                        >
                            <!-- Icono Casa -->
                            ...
                            <div class="text-left hidden md:block">
                                <p class="text-[10px] uppercase font-bold text-gray-400 dark:text-zinc-400 leading-none truncate max-w-[140px]">
                                    {{ currentUnit.subdivision_name || 'Fraccionamiento' }}
                                </p>
                                <!-- MODIFICADO: Usamos address_label (Calle + #) -->
                                <p class="text-sm font-bold text-gray-700 dark:text-zinc-200 leading-tight truncate max-w-[140px]" :title="currentUnit.address_label || currentUnit.unit_number">
                        ...
                        >
                            <div 
                                ...
                                class="absolute right-0 mt-2 w-72 bg-white dark:bg-zinc-800 rounded-xl shadow-xl border border-gray-100 dark:border-zinc-700 py-2 z-50 origin-top-right ring-1 ring-black ring-opacity-5"
                            >
                                ...
                                <div class="max-h-60 overflow-y-auto custom-scrollbar">
                                    <template v-if="availableUnits.length > 0">
                                        <button 
                                            ...
                                            class="w-full text-left px-4 py-3 text-sm hover:bg-blue-50 dark:hover:bg-zinc-700 flex items-center justify-between group transition-colors border-l-4"
                                            :class="unit.property_id === currentUnit.property_id ? 'bg-blue-50/50 dark:bg-zinc-700/30 border-blue-500' : 'border-transparent'"
                                        >
                                            <div class="flex flex-col">
                                                <span class="text-xs text-gray-500 dark:text-zinc-400 font-medium uppercase">
                                                    {{ unit.subdivision_name }}
                                                </span>
                                                <!-- MODIFICADO: Usamos address_label -->
                                                <span :class="unit.property_id === currentUnit.property_id ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-gray-700 dark:text-zinc-300 font-semibold'">
                                                ...
                                                <div class="flex items-center gap-2 mt-1">
                                                    ...
                                                    <span v-if="unit.role_in_unit && unit.role_in_unit !== 'Staff'" class="text-[10px] text-gray-400 bg-gray-100 dark:bg-zinc-900 px-1.5 py-0.5 rounded">
                                                        {{ unit.role_in_unit }}
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="border-t border-gray-100 dark:border-zinc-700 mt-1 pt-1">
                    ...
                    <div class="hidden lg:flex flex-col items-end border-l border-gray-200 dark:border-zinc-700 pl-4 h-8 justify-center">
                        <span class="text-[10px] text-gray-400 dark:text-zinc-500 uppercase font-bold tracking-wider">ROL ACTUAL</span>
                        <span class="text-xs font-bold text-gray-700 dark:text-zinc-300 bg-gray-100 dark:bg-zinc-700 px-2 py-0.5 rounded-md">
                            {{ currentRole }}
                        </span>
                     </div>
