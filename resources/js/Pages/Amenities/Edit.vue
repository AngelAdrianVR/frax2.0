                ...
                <div class="bg-white dark:bg-zinc-800 rounded-3xl shadow-xl overflow-hidden">
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-8">
                            <h2 class="text-2xl font-bold text-zinc-900 dark:text-white">Editar Amenidad</h2>
                        ...
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 mb-4">
                                    ...
                                    <button @click="addRule" type="button" class="px-4 py-2 bg-zinc-200 text-zinc-700 rounded-md hover:bg-zinc-300">Agregar</button>
                                </div>
                                <ul class="space-y-2">
                                    <li v-for="(rule, idx) in form.rules" :key="idx" class="flex justify-between items-center bg-zinc-100 dark:bg-zinc-700 px-4 py-2 rounded-lg">
                                        <span class="text-zinc-800 dark:text-zinc-200">{{ rule }}</span>
