        ...
        <div class="py-8">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h2 class="text-lg font-medium text-zinc-100 tracking-tight">Nueva Amenidad</h2>
                        <p class="text-sm text-zinc-400 mt-1">Configura los detalles, costos y horarios para que los residentes puedan reservar.</p>
                    </div>
