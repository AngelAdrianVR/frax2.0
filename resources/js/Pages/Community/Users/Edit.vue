        ...
        <div class="py-12 bg-zinc-50 dark:bg-zinc-900 min-h-screen transition-colors duration-300">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 px-4 sm:px-0 flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-zinc-900 dark:text-white tracking-tight">Editar Residente</h1>
                        <p class="text-zinc-500 dark:text-zinc-400 mt-1">Actualiza la información de {{ form.name }}.</p>
                    </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6" autocomplete="off">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2 max-w-md">
                                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Nueva Contraseña (Temporal)</label>
                                    <div class="relative">
                                        <input 
