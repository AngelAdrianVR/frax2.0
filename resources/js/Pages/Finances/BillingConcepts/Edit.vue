        ...
        <div class="py-8">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-lg font-medium text-zinc-100 tracking-tight">Editar Concepto</h1>
                                ...
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.base_amount" type="number" step="0.01" min="0" required
                                            class="w-full pl-8 bg-zinc-800 border border-zinc-700/40 text-zinc-100 rounded-xl px-4 py-2.5 transition-all duration-200 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-600" />
                                    </div>
