        ...
        <div class="py-10">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Crear Concepto</h1>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Define una nueva cuota para tu fraccionamiento.</p>
                    </div>
                </div>
