        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Deuda Total -->
                    <div class="bg-white dark:bg-zinc-800 rounded-3xl p-6 shadow-sm border border-zinc-200 dark:border-zinc-700/50 flex items-center gap-5 transition-all hover:shadow-md">
                ...
                <!-- Lista de Cuotas -->
                <div class="bg-white dark:bg-zinc-800 rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-700/50 overflow-hidden">
