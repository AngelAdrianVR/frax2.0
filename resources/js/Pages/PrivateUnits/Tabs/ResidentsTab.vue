<template>
    <div class="space-y-4">
        <div v-if="unit.residents.length === 0" class="text-center py-10 bg-white dark:bg-gray-800 rounded-2xl border border-dashed border-gray-300">
            <i class="pi pi-users text-4xl text-gray-300 mb-2"></i>
            <p class="text-gray-500">No hay residentes registrados.</p>
        </div>

        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div 
                v-for="resident in unit.residents" 
                :key="resident.id"
            ...
            >
                ...
                <div class="h-12 w-12 rounded-full flex items-center justify-center text-lg font-bold"
                    :class="resident.pivot.role_in_unit === 'Dueño' 
