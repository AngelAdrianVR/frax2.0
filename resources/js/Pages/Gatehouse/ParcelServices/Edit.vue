            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-zinc-800 shadow-sm rounded-3xl overflow-hidden border border-zinc-200 dark:border-zinc-700/50">
                    <div class="px-8 py-6 border-b border-zinc-100 dark:border-zinc-700/50 flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-zinc-900 dark:text-white">Editar Paquete</h2>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400">Modifica los detalles o el estatus del paquete.</p>
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select v-model="form.private_unit_id" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition-colors" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input v-model="form.name" type="text" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 transition-colors" required />
                                <p v-if="form.errors.name" class="mt-2 text-sm text-rose-500">{{ form.errors.name }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Número de Guía</label>
                                <input v-model="form.tracking_number" type="text" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 font-mono transition-colors" />
