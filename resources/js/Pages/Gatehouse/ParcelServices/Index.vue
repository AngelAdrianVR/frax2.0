    ...
    <AppLayout title="Paquetería">
        ...
        <div class="py-12 bg-[#F2F2F7] dark:bg-zinc-900 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <!-- Empty State -->
                <div v-if="parcels.data.length === 0" class="bg-white dark:bg-zinc-800 rounded-3xl shadow-sm p-12 text-center border border-zinc-200 dark:border-zinc-700/50">
                    <div class="w-20 h-20 bg-zinc-50 dark:bg-zinc-700/50 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <!-- Tabla de Datos -->
                <div v-else class="bg-white dark:bg-zinc-800 shadow-sm rounded-3xl overflow-hidden border border-zinc-200 dark:border-zinc-700/50">
