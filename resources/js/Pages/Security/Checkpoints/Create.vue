        ...
        <div class="py-12 bg-zinc-50 dark:bg-zinc-900 min-h-screen">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center gap-4 px-4 sm:px-0">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Nuevo Punto de Control</h1>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Registra un nuevo punto físico para los rondines.</p>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="submit" class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-zinc-500">Identificador único que el guardia escaneará.</p>
