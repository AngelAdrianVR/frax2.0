            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-zinc-800 shadow-sm border border-zinc-200 dark:border-zinc-700 sm:rounded-3xl overflow-hidden">
                    <div class="px-6 py-8 sm:p-10">
                        <div class="mb-8">
                            <h2 class="text-xl font-bold text-zinc-900 dark:text-white tracking-tight">Detalles del Rondín</h2>
                            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Ingresa la información del recorrido de seguridad manual.</p>
                        </div>
