    ...
    <AppLayout title="Bitácora de Rondines">
        ...
        <div class="py-12 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <!-- Estado Vacío -->
                <div v-if="patrols.data.length === 0" class="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm p-12 text-center border border-dashed border-zinc-300 dark:border-zinc-900">
                    <div class="w-16 h-16 bg-zinc-100 dark:bg-zinc-900/50 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <!-- Tabla de Datos -->
                <div v-else class="bg-white dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-900 sm:rounded-2xl overflow-hidden">
