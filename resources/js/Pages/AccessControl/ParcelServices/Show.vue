...
<template>
    <AppLayout title="Detalle de Paquete">
        <Toast />
        <div class="py-12 min-h-screen flex items-center justify-center p-4">
            ...
            <div class="max-w-md w-full">
                ...
                <div class="bg-white dark:bg-zinc-900 rounded-[2rem] shadow-xl overflow-hidden relative">
                    ...
                    <!-- Separador dentado -->
                    <div class="relative flex justify-between items-center bg-white dark:bg-zinc-900 h-8 -my-4 z-10">
                        <div class="w-8 h-8 bg-zinc-100 dark:bg-zinc-950 rounded-full -ml-4 shadow-inner"></div>
                        <div class="border-t-2 border-dashed border-zinc-200 dark:border-zinc-700 flex-grow mx-4"></div>
                        <div class="w-8 h-8 bg-zinc-100 dark:bg-zinc-950 rounded-full -mr-4 shadow-inner"></div>
                    </div>
                    ...
                    <div class="px-8 pt-8 pb-8 space-y-6">
                        ...
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800/50">
