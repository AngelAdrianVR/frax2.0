            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 px-4 sm:px-0">
                    <div class="flex items-center gap-4">
                        <Link :href="route('checkpoints.index')" class="w-10 h-10 bg-white dark:bg-zinc-900 rounded-full flex items-center justify-center shadow-sm border border-zinc-200 dark:border-zinc-900 text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">
                    ...
                    <Link :href="route('checkpoints.edit', checkpoint.id)" class="px-4 py-2 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-600 hover:bg-zinc-50 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-300 rounded-xl shadow-sm text-sm font-medium transition-colors inline-flex items-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-900 p-6">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-900 overflow-hidden h-full">
