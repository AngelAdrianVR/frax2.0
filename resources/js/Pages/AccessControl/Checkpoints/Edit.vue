        ...
        <div class="py-8">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-center gap-4 px-4 sm:px-0">
                    ...
                    <div>
                        <h1 class="text-lg font-medium text-zinc-100 tracking-tight">Editar Punto de Control</h1>
                    ...
                    <form @submit.prevent="submit" class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input v-model="form.name" type="text" id="name" 
                                class="w-full bg-zinc-800 border border-zinc-700/40 text-zinc-100 rounded-xl px-4 py-2.5 transition-all duration-200 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-600" required />
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.coordinates" type="text" id="coordinates" 
                                        class="w-full pl-11 bg-zinc-800 border border-zinc-700/40 text-zinc-100 rounded-xl px-4 py-2.5 transition-all duration-200 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-600" />
                                </div>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.tag_nfc_id" type="text" id="tag_nfc_id" 
                                        class="w-full pl-11 bg-zinc-800 border border-zinc-700/40 text-zinc-100 rounded-xl px-4 py-2.5 transition-all duration-200 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-600 font-mono" />
                                </div>
