    ...
    <AppLayout title="Bitácora de Visitas">
        <div class="py-8 md:py-12 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <!-- Empty State -->
                <div v-if="visits.data.length === 0" class="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm p-12 text-center border border-zinc-100 dark:border-zinc-900/50 mx-4 sm:mx-0">
