...
<template>
    <AppLayout title="Detalle de Visita">
        <div class="py-8 md:py-12 min-h-screen flex items-center justify-center">
            <div class="w-full max-w-md mx-auto sm:px-6 lg:px-8 px-4">
                ...
                <div class="relative bg-white dark:bg-zinc-900 shadow-2xl rounded-[2.5rem] overflow-hidden border border-zinc-100 dark:border-zinc-900/50">
                    ...
                    <div class="bg-indigo-600 p-8 text-center text-white relative">
                        ...
                        <div class="absolute -bottom-4 -left-4 w-8 h-8 bg-zinc-100 dark:bg-zinc-950 rounded-full"></div>
                        <div class="absolute -bottom-4 -right-4 w-8 h-8 bg-zinc-100 dark:bg-zinc-950 rounded-full"></div>
                    </div>
                    ...
                    <div class="p-8 pt-10 relative">
                        ...
                        <!-- Info Grid -->
                        <div class="bg-zinc-100 dark:bg-zinc-800/50 rounded-2xl p-5 space-y-4">
                            <div>
